!(function (e) {
  ...
  function (e, n, t) {
    ...
    var r = t(3),
      ...
      o = t(0);
    const i = {
      0: Object(o.a)("user.gender.unregistered"),
      1: Object(o.a)("user.gender.male"),
      2: Object(o.a)("user.gender.female"),
      9: Object(o.a)("user.gender.other"),
    };
    history.replaceState(null, "", "mypage.html");
    const s = Object(a.d)();
    s || Object(a.j)(),
      $(function () {
        const e = Object(a.f)(s);
        e &&
          ($("#email").text(e.email),
          $("#username").text(e.username),
          "premium" === e.rank
            ? $("#rank").text(Object(o.a)("user.rank.premium"))
            : "normal" === e.rank &&
              $("#rank").text(Object(o.a)("user.rank.normal")),
          $("#address").text(
            e.address ? e.address : Object(o.a)("user.unregistered")
          ),
          $("#tel").text(e.tel ? e.tel : Object(o.a)("user.unregistered")),
          $("#gender").text(i[e.gender]),
          $("#birthday").text(
            e.birthday
              ? Object(r.c)(Object(r.f)(e.birthday))
              : Object(o.a)("user.unregistered")
          ),
          $("#notification").text(
            e.notification
              ? Object(o.a)("user.notification.true")
              : Object(o.a)("user.notification.false")
          ),
          e.icon &&
            $("<img>", {
              class: "img-thumbnail",
              ...
              css: { backgroundColor: e.icon.color },
          ...
          e.preset ||
            ...
            $("#delete-form > button").prop("disabled", !1),
            $("#delete-form").submit(function () {
              if (!confirm(Object(o.a)("user.deleteConfirm"))) return !1;
              Object(a.i)(),
                localStorage.removeItem(e.email),
                alert(Object(o.a)("user.deleteComplete"));
            })));
      });
  },
]);
