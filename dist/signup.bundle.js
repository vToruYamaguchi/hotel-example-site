    ...
    Object(a.d)() && Object(a.j)(),
      $(function () {
        $("#signup-form").submit(function () {
          if (
            (Object(r.a)($(this).find("input")), $("#email")[0].checkValidity())
          ) {
            Object(a.f)($("#email").val()) &&
              $("#email")[0].setCustomValidity(
                Object(i.a)("validation.existsMail")
              );
          }
          if (
            ($("#password")[0].checkValidity() &&
              $("#password-confirmation")[0].checkValidity() &&
              $("#password").val() !== $("#password-confirmation").val() &&
              $("#password-confirmation")[0].setCustomValidity(
                Object(i.a)("validation.passwordUnmatch")
              ),
            !this.checkValidity())
          )
            return (
