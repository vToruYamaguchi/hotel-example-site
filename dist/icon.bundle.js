  ...
  function (e, t, n) {
    ...
    const a = { ja: n(5), "en-US": n(6) },
      ...
      s = {
        ja: function (e) {
          return (
            e.getFullYear() + "/" + v(e.getMonth() + 1) + "/" + v(e.getDate())
          );
        },
        "en-US": function (e) {
          return (
            v(e.getMonth() + 1) + "/" + v(e.getDate()) + "/" + e.getFullYear()
          );
        },
      },
      l = {
        ...
        $("#icon").change(function () {
          ...
          return (
            ...
            e
              ? e.size > 10240
                ? ($("#icon-holder").empty(),
                  $("#zoom").prop("disabled", !0),
                  $("#color").prop("disabled", !0),
                  this.setCustomValidity(Object(o.a)("validation.underTenKb")),
                  Object(r.b)($(this)),
                  void $("#icon-form").addClass("was-validated"))
                : /^image\/.+$/.test(e.type)
                ? ($("<img>", {
                    id: "icon-img",
                    class: "img-thumbnail",
                  ...
                  $("#zoom").prop("disabled", !1),
                  $("#zoom").change(function () {
                    $("#icon-img")
                      .width(parseInt($(this).val(), 10))
                      .height(parseInt($(this).val(), 10));
                  }),
                  $("#color").prop("disabled", !1),
                  void $("#color").change(function () {
                ...
                : ($("#icon-holder").empty(),
                  ...
                  $("#color").prop("disabled", !0),
                  this.setCustomValidity(
                    Object(o.a)("validation.onlyImageFile")
                  ),
                  Object(r.b)($(this)),
                  void $("#icon-form").addClass("was-validated"))
              : ($("#icon-holder").empty(),
                $("#zoom").prop("disabled", !0),
                void $("#color").prop("disabled", !0))
          );
        }),
          $("#icon-form").submit(function () {
            if (!this.checkValidity())
              return (
                Object(r.b)($("#icon")), $(this).addClass("was-validated"), !1
              );
            {
              const e = $("#icon").prop("files")[0],
                t = new FileReader();
              (t.onload = function (e) {
                (s.icon = {
                  ...
                  localStorage.setItem(s.email, JSON.stringify(s));
              }),
                t.readAsDataURL(e);
            }
          }),
